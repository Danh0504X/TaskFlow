    ...
    <section className="bg-white rounded-3xl p-6 shadow-sm border border-[#c7c4d7]/30">
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-end">
          <span className="text-[28px] font-bold text-[#121c2a] leading-none">
            5 <span className="text-base font-normal text-[#464554]">/ 15 lượt</span>
          </span>
          <span className="text-xs font-bold text-[#4648d4]">
            Còn lại 67%
          </span>
        </div>
        <div className="w-full h-3 bg-[#e6eeff] rounded-full overflow-hidden">
          <div
