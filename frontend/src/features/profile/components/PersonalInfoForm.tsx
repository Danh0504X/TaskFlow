      ...
      <form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={handleSubmit}>
        ...
        <div className="col-span-2 mt-4 pt-8 border-t border-[#c7c4d7]/30 flex justify-end gap-3">
          <button
            ...
            className="px-6 py-2.5 rounded-xl text-[#121c2a] font-semibold hover:bg-[#e6eeff] transition-colors focus:ring-2 focus:ring-offset-2 focus:ring-[#c7c4d7] outline-none disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Hủy
          </button>
          <button
            type="submit"
            disabled={!isDirty || updateProfileMutation.isPending}
            className="px-6 py-2.5 bg-[#4648d4] text-white rounded-xl font-semibold hover:bg-[#6063ee] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
