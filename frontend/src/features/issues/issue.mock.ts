...
const MOCK_ISSUES: Issue[] = [
  {
    ...
    projectId: '', assignee: members.alex,
    createdAt: '2026-06-01', updatedAt: '2026-07-08',
  },
  {
    _id: 'mock-i2', key: 'NEB-02', summary: 'Thiết kế giao diện Dark mode cho ứng dụng di động',
    type: 'TASK', status: 'TODO', priority: 'MEDIUM', epicName: 'UI/UX Design',
    projectId: '', assignee: members.alex,
  ...
  },
  {
    ...
    type: 'TASK', status: 'IN_PROGRESS', priority: 'URGENT', epicName: 'Security',
    projectId: '', assignee: members.sarah,
    createdAt: '2026-06-12', updatedAt: '2026-07-08',
  },
  {
    _id: 'mock-i4', key: 'NEB-04', summary: 'Sửa lỗi không nhận diện được Slack API Signature Token',
    type: 'BUG', status: 'IN_REVIEW', priority: 'HIGH', epicName: 'Slack Integration',
    projectId: '', assignee: members.james,
    createdAt: '2026-06-20', updatedAt: '2026-07-07',
  },
  {
    _id: 'mock-i5', key: 'NEB-05', summary: 'Viết bộ khung kiểm thử đơn vị cho API Middleware Auth',
    type: 'TASK', status: 'DONE', priority: 'LOW', epicName: 'Testing Unit',
    projectId: '', assignee: members.emily,
    createdAt: '2026-06-05', updatedAt: '2026-06-29',
  },
  {
    _id: 'mock-i6', key: 'NEB-06', summary: 'Tinh chỉnh lại các thành phần giao diện kính mờ (Glassmorphism)',
    type: 'SUBTASK', status: 'IN_REVIEW', priority: 'HIGH',
    projectId: '', assignee: members.sarah,
    createdAt: '2026-06-18', updatedAt: '2026-07-06',
  },
  {
    _id: 'mock-i7', key: 'NEB-07', summary: 'Thiết lập hạ tầng thanh toán Stripe Webhook để đồng bộ trạng thái đăng ký',
    type: 'TASK', status: 'TODO', priority: 'HIGH', epicName: 'Payment Flow',
    projectId: '', assignee: undefined,
